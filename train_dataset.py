...
## Paper says: "To augment training data, we implement random rotation (90, 180 or 270 degrees) and random horizontal flip."
def augment(hazy, clean):
    augmentation_method = random.choice([0, 1, 2, 3, 4])
    ...
    if augmentation_method == 1:
        ...
        return hazy, clean
    '''no change'''
    if augmentation_method == 2 or augmentation_method == 3 or augmentation_method == 4:
        return hazy, clean
